...
obj/$(target)/liblrs.rlib: obj/$(target)/liblrs_cfg.rlib obj/$(target)/liblrs_hash.rlib obj/$(target)/liblrs_iter.rlib obj/$(target)/liblrs_arch_fns.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_r_syscall.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_inotify.rlib obj/$(target)/liblrs_int.rlib obj/$(target)/liblrs_kernel.rlib obj/$(target)/liblrs_ringbuf.rlib obj/$(target)/liblrs_mem.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_io.rlib obj/$(target)/liblrs_hashmap.rlib obj/$(target)/liblrs_fs.rlib obj/$(target)/liblrs_swap.rlib obj/$(target)/liblrs_cty_base.rlib obj/$(target)/liblrs_user_group.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_getopt.rlib obj/$(target)/liblrs_process.rlib obj/$(target)/liblrs_parse.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_saturating.rlib obj/$(target)/liblrs_fd.rlib obj/$(target)/liblrs_rt.rlib obj/$(target)/liblrs_netlink.rlib obj/$(target)/liblrs_box.rlib obj/$(target)/liblrs_atomic.rlib obj/$(target)/liblrs_lock.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_tty.rlib obj/$(target)/liblrs_mqueue.rlib obj/$(target)/liblrs_wrapping.rlib obj/$(target)/liblrs_libc.rlib obj/$(target)/liblrs_sys.rlib obj/$(target)/liblrs_time_ext.rlib obj/$(target)/liblrs_dir.rlib obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_dev.rlib obj/$(target)/liblrs_tree.rlib obj/$(target)/liblrs_clone.rlib obj/$(target)/liblrs_buf_reader.rlib obj/$(target)/liblrs_socket.rlib obj/$(target)/liblrs_poll.rlib obj/$(target)/liblrs_queue.rlib obj/$(target)/liblrs_env.rlib obj/$(target)/liblrs_file.rlib obj/$(target)/liblrs_thread.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_event.rlib obj/$(target)/liblrs_pipe.rlib obj/$(target)/liblrs_cell.rlib obj/$(target)/liblrs_time_base.rlib obj/$(target)/liblrs_c_ptr_ptr.rlib obj/$(target)/liblrs_signal.rlib obj/$(target)/liblrs_rc.rlib obj/$(target)/liblrs_str_three.rlib 
...
obj/$(target)/liblrs_iter.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_vec.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/iter/lib.rs

-include obj/$(target)/lrs_vec.d
obj/$(target)/liblrs_vec.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_io.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_alloc.rlib 
...
obj/$(target)/liblrs_alloc.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_libc.rlib obj/$(target)/liblrs_syscall.rlib 
...
obj/$(target)/liblrs_rmo.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_alloc.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/rmo/lib.rs

-include obj/$(target)/lrs_str_two.d
obj/$(target)/liblrs_str_two.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_arch_fns.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_alloc.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/str_two/lib.rs

-include obj/$(target)/lrs_inotify.d
obj/$(target)/liblrs_inotify.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_fd.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_io.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_rmo.rlib 
...
-include obj/$(target)/lrs_str_three.d
obj/$(target)/liblrs_str_three.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_arch_fns.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_alloc.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/str_three/lib.rs
...
obj/$(target)/liblrs_fs.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_rmo.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/fs/lib.rs

-include obj/$(target)/lrs_swap.d
obj/$(target)/liblrs_swap.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_str_three.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/swap/lib.rs

-include obj/$(target)/lrs_user_group.d
obj/$(target)/liblrs_user_group.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_arch_fns.rlib obj/$(target)/liblrs_io.rlib obj/$(target)/liblrs_buf_reader.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_parse.rlib obj/$(target)/liblrs_file.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_iter.rlib obj/$(target)/liblrs_alloc.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/user_group/lib.rs
...
obj/$(target)/liblrs_file.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_io.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_int.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_arch_fns.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_parse.rlib obj/$(target)/liblrs_fd.rlib obj/$(target)/liblrs_dev.rlib obj/$(target)/liblrs_fs.rlib obj/$(target)/liblrs_time_base.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_rmo.rlib 
...
obj/$(target)/liblrs_process.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_c_ptr_ptr.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_rt.rlib obj/$(target)/liblrs_env.rlib obj/$(target)/liblrs_file.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_time_base.rlib 
...
obj/$(target)/liblrs_env.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_rt.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_rmo.rlib 
...
obj/$(target)/liblrs_mqueue.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_fd.rlib obj/$(target)/liblrs_file.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_alloc.rlib obj/$(target)/liblrs_time_base.rlib obj/$(target)/liblrs_rv.rlib 
	lrsc --emit=link,dep-info --out-dir obj/$(target) --target $(target) src/mqueue/lib.rs

-include obj/$(target)/lrs_sys.d
obj/$(target)/liblrs_sys.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_rv.rlib obj/$(target)/liblrs_time_base.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_alloc.rlib 
...
obj/$(target)/liblrs_dir.rlib: obj/$(target)/liblrs_core.rlib obj/$(target)/liblrs_base.rlib obj/$(target)/liblrs_cty.rlib obj/$(target)/liblrs_str_one.rlib obj/$(target)/liblrs_str_two.rlib obj/$(target)/liblrs_str_three.rlib obj/$(target)/liblrs_syscall.rlib obj/$(target)/liblrs_fd.rlib obj/$(target)/liblrs_fmt.rlib obj/$(target)/liblrs_file.rlib obj/$(target)/liblrs_vec.rlib obj/$(target)/liblrs_rmo.rlib obj/$(target)/liblrs_alloc.rlib 
