...
fn path_from_char_device(d: Device) -> LinuxString {
    ...
    match (major) {
        ...
        154 => p!("ttySR{}", minor),
        155 => p!("cusr{}", minor),
        156 => p!("ttySR{}", minor + 256),
        157 => p!("cusr{}", minor + 256),
        158 => p!("gfax{}", minor),
        160 => p!("gpib{}", minor),
        161 => match minor / 16 {
            0 => p!("ircomm{}", minor),
    ...
    match (major) {
        ...
        101 => {
            match minor % 16 {
                ...
                n => p!("amiraid/ar{}p{}", minor / 16, minor % 16),
            }
        },
        102 => {
            let letter = (b'a' + (minor / 16)) as char;
